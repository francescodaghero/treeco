"""
A mirror of the file in XDSL:
https://github.com/xdslproject/xdsl/blob/main/xdsl/transforms/convert_ml_program_to_memref.py

The only change is the import of the custom ml_program dialect declared in treeco.
"""
